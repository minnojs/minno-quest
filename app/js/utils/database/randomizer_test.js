define(['./database-module'], function(){
	...
	describe('database.randomizer', function(){
		...
		beforeEach(inject(function(Randomizer){
			randomSpy.reset();
			exRandomSpy.reset();
			rand = new Randomizer();
		}));

		describe('Randomizer.random', function(){
		...
		describe('Randomizer.sequential', function(){
		...
		describe('Randomizer.exRandom', function(){
			it('should return the next number', function(){
			...
			it('should allow multiple seeds', function(){
				rand.exRandom(null, "seed1");
				rand.exRandom(null, "seed2");
				expect(exRandomSpy.callCount).toBe(2);
			});
		});
	});
