define(['questAPI'], function(Quest){
	 ...
	 * Sequence
	 *
	 * This questionniare has several demographic/personal questions that appear at the begining in a constant order.
	 * After them we have a series of general questions that appear in a random order.
	 */
	API.addSequence([
		/**
		 * Basic weight segment
		...
		/**
		 * Weight segment.
		 * This segment has several generic questions, their order is randomized using a `random` mixer.
		 */
		{
			mixer: 'random',
			data:[
