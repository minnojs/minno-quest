...
describe('piConsole', function(){
    ...
    describe(': prototype', function(){
        ...
        describe(': loggers', function(){
            ...
            beforeEach(function(){
                $console.shouldLog = jasmine.createSpy('log').and.returnValue(true); // just automatically log everything...
            });
            ...
            it('should not log if !shouldLog', function(){
                $console.shouldLog.and.returnValue(false); // deactivate shouldlog
                $console.log('test');
                $log.assertEmpty();
            });
            ...
            it('should broadcast log information', function(){
                ...
                expect(spy.calls.mostRecent().args[1]).toEqual(jasmine.any(Object));
                expect(spy.calls.mostRecent().args[1].type).toEqual('log');
                expect(spy.calls.mostRecent().args[1].tags).toEqual(['tag1','tag2']);
                expect(spy.calls.mostRecent().args[1].args).toEqual(['args1','args2']);
