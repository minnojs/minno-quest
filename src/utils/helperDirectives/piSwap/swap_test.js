...
angular.module('piSwap',['ngAnimateMock']).directive('piSwap', piSwapDirective);
import piSwapDirective from './piSwapDirective';
...
describe('piSwap', function(){
    ...
    describe(': next', function(){
        ...
        it('should compile transclude only once', function(){
            controller.next({});
            expect(testSpy.calls.count()).toBe(1);
        });
        ...
        it('should call pre before compiling', function(){
            var preSpy = jasmine.createSpy('pre').and.callFake(function(){
                expect(testSpy).not.toHaveBeenCalled();
            });
        ...
        it('should call post after compiling', inject(function($animate){
            var postSpy = jasmine.createSpy('post').and.callFake(function(){
                expect(testSpy).toHaveBeenCalled();
            });
