            ...
            questions: [
{
	...
	rows: ['Friend 1', 'Friend 2' ]
                ...
                },
                {
                    ...
                    columns: [
                        {type:'dropdown', answers: ['asdf', {text:'cvb', value:444}]}, 
                        'agree' , 'don\'t know' , 'disagree' , 
                        {stem:'Strongly disagree', type:'input'}
                    ],
                    rows: ['I like grids', {stem: 'I like bannanas too', overwrite: [null, null, {type:'dropdown', answers: ['asdfdfffff', 2345]}]}],
